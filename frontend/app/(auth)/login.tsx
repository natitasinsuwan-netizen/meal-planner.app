    ...
    <SafeAreaView style={styles.safe} edges={["top", "bottom"]}>
      ...
      >
        <View style={styles.brandWrap}>
          ...
          <Text style={styles.subtitle}>Sign in to plan today&apos;s meals.</Text>
        </View>
        ...
        <View style={[styles.card, SHADOW.soft]}>
          ...
          <Button label="Sign in" loading={busy} onPress={onSubmit} testID="login-submit-button" />
        </View>

        <View style={styles.footer}>
          <Text style={styles.footText}>New here?</Text>
          <Link href="/(auth)/register" replace testID="goto-register-link">
            <Text style={styles.footLink}> Create an account</Text>
          </Link>
        </View>
      </KeyboardAwareScrollView>
    </SafeAreaView>
